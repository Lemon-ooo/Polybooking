    ...
    return (
      <div style={{ padding: "120px 20px", textAlign: "center" }}>
        <Alert
          ...
          showIcon
          action={
            <Button onClick={() => tableQueryResult?.refetch()}>Thử lại</Button>
          }
        />
      </div>
    );
        ...
        <div className="container">
          ...
          {isLoading ? (
            ...
            <Row gutter={[24, 40]} justify="center">
              {rooms.map((room) => (
                <Col xs={24} sm={12} lg={8} key={room.room_type_id}>
                  <div
                    className="room-item"
                    onClick={() => handleViewDetails(room.room_type_id)}
                  >
                    ...
                    <div className="room-item-content">
                      ...
                      <p className="room-item-desc">
                        {room.description ||
                          "Phòng nghỉ sang trọng với thiết kế tinh tế và tiện nghi cao cấp."}
                      </p>
                      ...
                      <div className="room-features">
                        ...
                        <div className="room-feature-item">
                          <svg fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm2-13c0 .28-.21.52-.5.5A5.98 5.98 0 0 0 7 12c0 2.76 2.24 5 5 5 .28 0 .5-.22.5-.5s-.22-.5-.5-.5c-2.21 0-4-1.79-4-4 0-2.21 1.79-4 4-4 .28 0 .5.22.5.5s-.22.5-.5.5z" />
                          </svg>
                          <span>City View</span>
                        </div>
                        <div className="room-feature-item">
                          <svg fill="currentColor" viewBox="0 0 20 20">
                            <path d="M3 12h4v5h6v-5h4l-7-7-7 7zm5-10v4h4V2z" />
                          </svg>
                          <span>1 King-size bed</span>
                        </div>
                        <div className="room-feature-item">
                          <svg fill="currentColor" viewBox="0 0 20 20">
                            <path d="M12 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM9.5 10a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm5 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" />
                          </svg>
                      ...
                      <div className="room-item-footer">
                        ...
                        <button className="room-details-btn">
                          Room Details
                        </button>
                      </div>
                    </div>
