...
export const dataProvider: DataProvider = {
  ...
  create: async ({ resource, variables, meta }) => {
    try {
      ...
      const mappedData = {
        id: responseData.data.id || responseData.data.room_id,
        ...responseData.data,
      };
