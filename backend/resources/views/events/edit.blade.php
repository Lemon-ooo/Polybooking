<!-- filepath: c:\xampp\htdocs\Polybooking\backend\resources\views\admin\events\edit.blade.php -->
@extends('layouts.admin')

@section('content')
<div class="container">
    <h1 class="mb-4">Chỉnh sửa Event</h1>
    ...
    <form action="{{ route('web.events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <button type="submit" class="btn btn-success">Cập nhật Event</button>
