...
<div class="page-container">
    <div class="header-row">
        <h2 class="page-title">Chỉnh sửa tiện ích</h2>
    ...
    <div class="card">
        <form action="{{ route('web.amenities.update', $amenity->amenity_id) }}" method="POST" class="form-grid" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                @if($amenity->icon_path)
                    <div style="margin-top:10px;">
                        <p>Ảnh hiện tại:</p>
                        <img src="{{ $amenity->iconUrl }}" width="80" style="border-radius:6px; border:1px solid #ddd;">
                    </div>
                @endif
            </div>
