      ...
      >
        <Routes>
          ...
          >
            ...
            {/* customers */}
            <Route path="customers" element={<EventList />} />
            <Route path="customers/create" element={<EventCreate />} />
            <Route path="customers/show/:id" element={<EventShow />} />
            <Route path="customers/edit/:id" element={<EventEdit />} />
          </Route>
