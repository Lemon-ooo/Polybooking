...
// import { AdminLayout } from "./components/layout/AdminLayout"; // Admin tạm comment
...
import { dataProvider } from "./providers"; // chỉ giữ dataProvider
    ...
    <BrowserRouter>
      ...
      >
        <Routes>
          ...
          {/* Admin routes tạm comment để test */}
          {/*
