...
// Hero Section giống Rue de l’Amour
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 800 }}>
        ...
        <p style={{ fontSize: "20px", letterSpacing: "2px", marginTop: 16 }}>
...
// Footer đơn giản giống Rue de l’Amour
  ...
  return (
    ...
    >
      ...
      <Header style={headerStyle}>
        ...
        >
          <img
            src={assets.logo}
            alt="Hotel Deluxe"
            style={{ height: isMobile ? 32 : 40, transition: "all 0.3s ease" }}
          />
          {!isMobile && (
            <div
              style={{
        ...
        {isMobile && (
          <Space size={16}>
            ...
            <Button
              type="text"
              icon={
                <MenuOutlined style={{ fontSize: 20, color: colors.text }} />
              }
      ...
      <Drawer
        ...
        width={320}
        closeIcon={
          <CloseOutlined style={{ color: colors.text, fontSize: 16 }} />
        }
        bodyStyle={{ background: "#0a0a0a", padding: 0 }}
        headerStyle={{
          background: "#0a0a0a",
