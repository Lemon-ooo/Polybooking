...
export const RoomDetail: React.FC = () => {
  ...
  const defaultRoom: RoomDetail = {
    ...
    description: "Phòng Deluxe King sang trọng với giường king-size, view thành phố tuyệt đẹp và đầy đủ tiện nghi cao cấp. Phòng được thiết kế hiện đại với không gian rộng rãi, phù hợp cho cả công tác và nghỉ dưỡng.",
    price: 2500000,
    images: [
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "2024-01-15",
      comment: "Phòng rất đẹp và sạch sẽ. Nhân viên nhiệt tình, view thành phố tuyệt vời!",
    ...
    },
    {
      ...
      rating: 4,
      date: "2024-01-10",
      comment: "Trải nghiệm tốt, phòng rộng rãi. Chỉ có wifi hơi chậm một chút.",
  ...
  const handleBookNow = () => {
    if (bookingDates) {
      ...
      Modal.info({
        title: "Chọn ngày",
        content: "Vui lòng chọn ngày nhận phòng và trả phòng để tiếp tục đặt phòng.",
      });
    }
  };
  ...
  if (isLoading) {
    return (
      <div className="loading-container">
        <Spin size="large" />
        <Text style={{ marginTop: 16, display: "block" }}>Đang tải thông tin phòng...</Text>
      </div>
    );
  }
          ...
          <Col xs={24} lg={16}>
            ...
            <div className="room-info-section">
              <div className="room-header">
                <Title level={1} className="room-title">{roomData.name}</Title>
                <div className="room-meta">
                  <Space size={16}>
                    <div className="rating">
                      <StarFilled style={{ color: "#ffc107" }} />
                      <Text strong>{roomData.rating}</Text>
                      <Text type="secondary">({roomData.reviews_count} đánh giá)</Text>
                    </div>
                ...
                <List
                  ...
                  renderItem={(review) => (
                    <List.Item className="review-item">
                      <List.Item.Meta
                        avatar={<img src={review.avatar} alt={review.name} className="review-avatar" />}
                        title={
          ...
          <Col xs={24} lg={8}>
            <Card className="booking-card" bordered={false}>
              <div className="price-section">
                ...
                <Text className="price-amount">{formatPrice(roomData.price)}</Text>
              ...
              <div className="cancellation-policy">
                ...
                <Text type="secondary">
                  Miễn phí hủy phòng trước 48 giờ. Hủy sau thời gian này sẽ bị tính phí 50% giá trị đặt phòng.
                </Text>
              </div>
            </Card>
          </Col>
