...
export const ClientRooms: React.FC = () => {
  ...
  return (
    <div className="client-rooms-container">
      ...
      <div className="rooms-hero-banner luxury-hero">
        <div
          className="hero-overlay luxury-overlay"
          style={{
            backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1920&h=600&fit=crop')`,
          }}
        >
          <div className="hero-content luxury-content">
            <Title level={1} className="hero-title luxury-title">
              Accommodations
            </Title>
            <Paragraph className="hero-subtitle luxury-subtitle">
              The system of 57 uniquely designed rooms, fully equipped, modern
              and attentive service will bring you different and memorable
              experiences at a luxury boutique hotel right in the heart of
              Hanoi.
            </Paragraph>
          </div>
        </div>
              ...
              <Row gutter={[0, 48]} justify="center">
                {rooms.map((room, index) => (
                  <Col
                    ...
                    key={room.id}
                    style={{
                      marginBottom: index < rooms.length - 1 ? 0 : "unset",
                    }}
                  >
                    <Card
                      ...
                      <Row gutter={[32, 32]} align="top">
                        <Col xs={24} md={10}>
                          <div className="room-image-container luxury-image">
                            ...
                            <Tag
                              ...
                              className="room-status-tag luxury-tag"
                            >
                        ...
                        <Col xs={24} md={14}>
                          <div className="room-info luxury-room-info">
                            <div className="room-header luxury-header">
                              <Space align="start" size={16}>
                                ...
                                <div className="room-rating luxury-rating">
                                  <StarFilled
                                    style={{
                                      color: "#c9a96e",
                                      fontSize: "16px",
                            ...
                            <Paragraph className="room-description luxury-description">
                              {room.description ||
                                ...
                                "Indulge in the epitome of luxury with our exquisitely designed accommodations, blending modern elegance with timeless comfort."}
                            </Paragraph>
