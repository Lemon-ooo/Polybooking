...
export default function ClientBooking() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const bId =
        bookingRes.data?.data?.booking_id || bookingRes.data?.booking_id;
  ...
  const handlePaymentModalClose = () => {
    if (paymentStatus === "success") {
      ...
      setSelectedRooms([]);
      setStep(1);
      message.info("Redirecting to your bookings...");
      setTimeout(() => {
        ...
        >
          ...
          {paymentStatus === "success" && (
            <Result
              ...
              subTitle={`Your booking #${bookingId} has been confirmed and paid.`}
              extra={[
                <Button
                  type="primary"
                  key="done"
