...
export const RoomEdit: React.FC = () => {
  ...
  // useForm Refine
  const { form, onFinish, saveButtonProps, queryResult } =
  ...
  // Khi data load xong, set giá trị cho form
  useEffect(() => {
    if (queryResult?.data) {
  ...
  // Nếu đang load data, show Skeleton
  if (queryResult.isLoading) {
    return <Skeleton active />;
  }

  if (queryResult.isError) {
    return <Alert message="Lỗi tải dữ liệu phòng" type="error" showIcon />;
  }
