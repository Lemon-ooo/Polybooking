...
export const UserShow: React.FC = () => {
  ...
  }, [id, queryResult, data, isLoading, isError, error]);
  ...
  if (isError) {
    return (
      <Alert
        ...
        description={
          <>
            <div>{error?.message || "Không thể kết nối đến API."}</div>
  ...
  if (!user) {
    return (
      <Alert
        ...
        description={
          <>
            <div>Không tìm thấy thông tin người dùng với ID: {id}</div>
            <div style={{ marginTop: 8, fontSize: 12 }}>
              <strong>Debug Info:</strong>
        ...
        <Card title="Chi tiết tài khoản" bordered={false}>
          <Descriptions column={{ xs: 1, sm: 2 }} bordered>
            ...
            <Descriptions.Item label="Ngày tạo">
              <Space>
                <CalendarOutlined />
                <DateField value={user.created_at} format="DD/MM/YYYY HH:mm" />
              </Space>
            </Descriptions.Item>
