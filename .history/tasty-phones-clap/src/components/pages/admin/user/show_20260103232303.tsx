...
export const UserShow: React.FC = () => {
  ...
  // Sử dụng useOne thay vì useShow để linh hoạt hơn
  const { data, isLoading, isError, error } = useOne<User>({
    resource: "users",
    id: id || "",
  });
  ...
  if (!user) {
    return (
      <Alert
        ...
        description={`Không tìm thấy thông tin người dùng với ID: ${id}`}
        type="warning"
        showIcon
        action={
          <Button onClick={() => navigate("/admin/users")}>
