        ...
        <Space>
          ...
          <Tooltip title="Gán phòng">
            <Button
              ...
              disabled={record.status === "paid" || record.status === "checked_out"}
            />
          </Tooltip>
          <Tooltip title="Xác nhận thanh toán">
            <Button
              ...
              disabled={record.status === "paid" || record.remaining_balance === 0}
            >
          ...
          <List.Item
            actions={[
              <Popconfirm
                ...
                okText="Xóa"
                cancelText="Hủy"
                disabled={selectedBooking.status === "paid" || selectedBooking.status === "checked_out"}
              >
                <Button
                  type="text"
                  danger
      ...
      <Modal
        ...
        footer={[
          ...
          <Button
            ...
            disabled={selectedBooking?.status === "paid" || selectedBooking?.remaining_balance === 0}
          >
            {selectedBooking?.remaining_balance > 0 ? "Xác nhận Thanh toán" : "Đã thanh toán"}
          </Button>,
        ]}
        width={800}
      >
          ...
          >
            ...
            <div style={{ marginBottom: 16 }}>
              <Statistic
                ...
                value={selectedBooking.remaining_balance}
                formatter={(value) => `${value?.toLocaleString()} ₫`}
                valueStyle={{
                  color:
                    selectedBooking.remaining_balance > 0
