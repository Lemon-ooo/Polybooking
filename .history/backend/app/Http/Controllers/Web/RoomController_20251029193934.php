    ...
    public function store(Request $request): JsonResponse
{
    $validated = $request->validate([
        ...
        'price' => 'required|numeric|min:0', // ✅ Thay nullable bằng required
        'status' => 'required|string|in:available,occupied,maintenance', // ✅ Thêm enum
        'amenities' => 'nullable|array', // ✅ Cho phép null
        'amenities.*' => 'exists:amenities,id', // ✅ Kiểm tra xem có phải amenity_id không?
    ]);
